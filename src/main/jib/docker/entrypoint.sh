...
echo -e "\nRunning CAS..."
exec java -Xms512m -Xmx2048M -XX:+TieredCompilation -XX:TieredStopAtLevel=1 -Dcas.standalone.configurationDirectory=/etc/cas/config -jar docker/cas/war/cas.war
